...
<script>
import { selectAllSendGift } from '@/api/user'
import { formatDate } from '@/common/util'

/**
"id": 609,
"number": 1,
"createtime": 1543907788,
"type": 0,  普通， 1 限量， 2 特效
"coin": 20,
"mobile": "18137854722",
"to_mobile": "18620769986",
"address": "huanggua.png",
"name": "黄瓜",
...
export default {
  ...
  data () {
    return {
      ...
      columns: [
        ...
        { title: '金币', key: 'coin' },
        { title: '赠送人电话', key: 'to_mobile' },
        { title: '被赠送人电话', key: 'mobile' },
  ...
  methods: {
    ...
    getList (page) {
      ...
      this.loading = true
      selectAllSendGift(pageNum, pageSize).then(data => {
        this.data = data.list
